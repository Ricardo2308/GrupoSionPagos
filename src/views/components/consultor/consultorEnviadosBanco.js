...
import { getConsultorEnviadosBanco } from 'src/services/getConsultorEnviadosBanco'
...
const ConsultorEnviadosBanco = (prop) => {
  ...
  useEffect(() => {
    ...
    getConsultorEnviadosBanco(idUsuario, session.api_token).then((items) => {
      if (mounted) {
        ...
        sessionStorage.setItem('ConsultorPagosEnviadosBanco', JSON.stringify(datosOrdenados))
      }
    })
...
export default ConsultorEnviadosBanco

...
import { getConsultorPendientes } from 'src/services/getConsultorPendientes'
import { useSession } from 'react-use-session'
import { FaList, FaFileUpload, FaFlag } from 'react-icons/fa'
...
const ConsultorPendientes = (prop) => {
  ...
  useEffect(() => {
    ...
    getConsultorPendientes(idUsuario, session.api_token).then((items) => {
      if (mounted) {
...
export default ConsultorPendientes

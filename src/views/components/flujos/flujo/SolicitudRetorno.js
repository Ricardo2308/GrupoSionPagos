...
const SolicitudRetorno = (prop) => {
  ...
  const OrdenarPorColumna = sessionStorage.getItem('OrdenarPorColumnaSR' + prop.tipo)
  const OrdenarPorDireccion = sessionStorage.getItem('OrdenarPorDireccionSR' + prop.tipo)
  ...
  function Ordenamiento(columna, direccion, e) {
    if (columna.name !== undefined) {
      sessionStorage.setItem('OrdenarPorColumnaSR' + prop.tipo, columna.name)
    }
    if (direccion) {
      sessionStorage.setItem('OrdenarPorDireccionSR' + prop.tipo, direccion)
    }
  }
